...
import (
	...
	"github.com/james077/bookstore_items-api/src/domain/items"
	"github.com/james077/bookstore_items-api/src/domain/queries"
	"github.com/james077/bookstore_items-api/src/services"
	"github.com/james077/bookstore_items-api/src/utils/http_utils"
	"github.com/james077/bookstore_oauth-go/oauth"
...
func (cont *itemsController) Create(w http.ResponseWriter, r *http.Request) {
	...
	if sellerId == 0 {
		respErr := rest_errors.NewUnauthorizedError("Token de acceso inválido")
	...
	if err != nil {
		respErr := rest_errors.NewBadRequestError("Contrucción de la solicitud inválida")
		http_utils.RespondError(w, respErr)
		return
	}
	defer r.Body.Close()
	...
	if err := json.Unmarshal(requestBody, &itemRequest); err != nil {
		respErr := rest_errors.NewBadRequestError("Item json body inválido")
		http_utils.RespondError(w, respErr)
		return
	}
...
func (c *itemsController) Search(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		apiErr := rest_errors.NewBadRequestError("json inválido")
